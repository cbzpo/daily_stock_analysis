  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'primary-gradient': 'linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(var(--primary) / 0.74) 100%)',
      },
      boxShadow: {
        'soft-card': 'var(--shadow-soft-card)',
        'soft-card-strong': 'var(--shadow-soft-card-strong)',
        'glow-cyan': '0 0 20px hsl(var(--primary) / 0.4)',
        'glow-purple': '0 0 20px hsl(var(--color-purple) / 0.3)',
        'glow-success': '0 0 20px hsl(var(--color-success) / 0.3)',
        'glow-danger': '0 0 20px hsl(var(--color-danger) / 0.3)',
